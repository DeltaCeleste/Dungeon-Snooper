...
class MyScene extends THREE.Scene {
  ...
  createGUI () {
    ...
    this.guiControls = {
      ...
      lightPower : 1.0,  // La potencia de esta fuente de luz se mide en lúmenes
    ...
    folder.add (this.guiControls, 'lightPower', 0, 5, 0.01)
      .name('Luz puntual : ')
  ...
  createRenderer (myCanvas) {
    ...
    renderer.setClearColor(new THREE.Color(0x223355), 1.0);
